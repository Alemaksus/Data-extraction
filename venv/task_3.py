...
class ScrapingJob():
    ...
    def _parser_hh(self, vacancy):
        ...
        for page in range(0, last_page):
            ...
            if html.ok:
                parsed_html = _get_parsed_html(html)
    ...
    def _parser_superjob(self, vacancy):
        ...
        html = self._get_html(self.link_superjob, params)
    ...
    def _parser_item_hh(self, item):
        ...
        # vacancyId
        vacancy_json = json.loads(
            item.find('script', {'data-name': 'HH/VacancyResponsePopup/VacancyResponsePopup'})['data-params'])
